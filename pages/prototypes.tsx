        ...
        <div className="h-full w-full p-4">
            ...
            <div className="mt-6">
                <button
                    ...
                    className={`transition-transform duration-200 ease-in-out w-full text-left bg-gray-800 p-4 rounded-2xl mb-4 ${
                ...
                >
                    <div className="mb-6">
                        ...
                        <h3 className="text-gray-50 font-bold text-xl">
                            Backgammon
                        </h3>
