...
export const Textarea: React.FunctionComponent<TextareaProps> = ({
    ...
    return (
        <textarea
            ...
            className={`${
                props.className || ""
            } transition-colors duration-200 ease-in-out w-full bg-transparent placeholder-gray-700 focus:outline-none text-gray-50 p-2 placeholder-gray-500 shadow-none rounded-md`}
            {...props}
        />
    );
};
